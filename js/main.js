...
const translations = {
  en: {
    ...
    'p2-client':  'Car Detailing · Hidd, Bahrain',
    'p2-title':   '3D Car Spa',
    'p2-desc':    'Premium mobile car detailing with a spa-quality finish — comes to you anywhere in Bahrain.',
    'p2-link':    'View Live →',

    'p3-client':  'Auto Detailing · Salmabad, Bahrain',
    'p3-title':   'Custom Touch Car Care',
    'p3-desc':    'Workshop-grade detailing — ceramic coatings, PPF, wrapping, and paint correction built for Gulf conditions.',
    'p3-link':    'View Live →',

    'p4-client':  'Premium Car Care · Tubli, Bahrain',
    'p4-title':   'Carbon Auto Studio',
    'p4-desc':    'Studio + mobile van premium detailing — ceramic coatings, PPF, and paint correction for daily drivers to GT3s.',
    'p4-link':    'View Live →',

    'p5-client':  'Italian Restaurant · Bahrain',
    'p5-title':   'Gusto Pizzeria Ristorante',
    'p5-desc':    'Authentic wood-fired Italian dining — a full-service restaurant site built to drive reservations.',
    'p5-link':    'View Live →',

    'p6-client':  'Mobile Car Wash · Manama, Bahrain',
    'p6-title':   'Evergood Carwash & Polishing',
    'p6-desc':    'Reliable, hand-wash mobile detailing — no swirl marks, no shortcuts, straight to your door.',
    'p6-link':    'View Live →',

    'p7-client':  'Mobile Car Wash · Bahrain',
    'p7-title':   'Excellent Car Wash',
    'p7-desc':    'Steam-powered mobile detailing that comes to you — home, office, or anywhere across Bahrain.',
    'p7-link':    'View Live →',
  ...
  ar: {
    ...
    'p2-client':  'تفصيل سيارات · حد، البحرين',
    'p2-title':   '3D Car Spa',
    'p2-desc':    'تفصيل سيارات متنقل بجودة سبا فاخرة — يصل إليك في أي مكان في البحرين.',
    'p2-link':    '← عرض مباشر',

    'p3-client':  'تفصيل سيارات · سلماباد، البحرين',
    'p3-title':   'Custom Touch Car Care',
    'p3-desc':    'تفصيل احترافي بمستوى الورشة — طلاءات سيراميك، PPF، تغليف، وتصحيح طلاء مصمم لظروف الخليج.',
    'p3-link':    '← عرض مباشر',

    'p4-client':  'عناية فاخرة بالسيارات · توبلي، البحرين',
    'p4-title':   'Carbon Auto Studio',
    'p4-desc':    'تفصيل فاخر بالاستوديو والشاحنة المتنقلة — طلاءات سيراميك، PPF، وتصحيح طلاء لكل سيارة.',
    'p4-link':    '← عرض مباشر',

    'p5-client':  'مطعم إيطالي · البحرين',
    'p5-title':   'Gusto Pizzeria Ristorante',
    'p5-desc':    'مطعم إيطالي أصيل بالفرن الحطبي — موقع متكامل مصمم لزيادة الحجوزات.',
    'p5-link':    '← عرض مباشر',

    'p6-client':  'غسيل سيارات متنقل · المنامة، البحرين',
    'p6-title':   'Evergood Carwash & Polishing',
    'p6-desc':    'تفصيل يدوي موثوق وبدون خدوش — يصل مباشرة إلى بابك.',
    'p6-link':    '← عرض مباشر',

    'p7-client':  'غسيل سيارات متنقل · البحرين',
    'p7-title':   'Excellent Car Wash',
    'p7-desc':    'تفصيل متنقل بالبخار يصل إليك — المنزل، المكتب، أو أي مكان في البحرين.',
    'p7-link':    '← عرض مباشر',
